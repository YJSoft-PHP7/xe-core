...
class Argument
{
		...
		if(isset($this->value) && $this->value != '')
		{
			...
			switch($filter_type)
			{
				...
				case 'email_address' :
					...
					{
						$this->isValid = FALSE;
						$this->errorMessage = new XEObject(-1, sprintf($lang->filter->invalid_email, $lang->{$key} ? $lang->{$key} : $key));
					}
					break;
				case 'homepage' :
					...
					{
						$this->isValid = FALSE;
						$this->errorMessage = new XEObject(-1, sprintf($lang->filter->invalid_homepage, $lang->{$key} ? $lang->{$key} : $key));
					}
					break;
				case 'userid' :
				case 'user_id' :
					...
					{
						$this->isValid = FALSE;
						$this->errorMessage = new XEObject(-1, sprintf($lang->filter->invalid_userid, $lang->{$key} ? $lang->{$key} : $key));
					}
					break;
				case 'number' :
				case 'numbers' :
					...
					{
						$this->isValid = FALSE;
						$this->errorMessage = new XEObject(-1, sprintf($lang->filter->invalid_number, $lang->{$key} ? $lang->{$key} : $key));
					}
					break;
				case 'alpha' :
					...
					{
						$this->isValid = FALSE;
						$this->errorMessage = new XEObject(-1, sprintf($lang->filter->invalid_alpha, $lang->{$key} ? $lang->{$key} : $key));
					}
					break;
				case 'alpha_number' :
					...
					{
						$this->isValid = FALSE;
						$this->errorMessage = new XEObject(-1, sprintf($lang->filter->invalid_alpha_number, $lang->{$key} ? $lang->{$key} : $key));
					}
					break;
			}
		}
	...
	function checkMaxLength($length)
	{
		if($this->value && (strlen($this->value) > $length))
		{
			...
			$this->isValid = FALSE;
			$key = $this->name;
			$this->errorMessage = new XEObject(-1, sprintf($lang->filter->outofrange, $lang->{$key} ? $lang->{$key} : $key));
		}
	}
	...
	function checkNotNull()
	{
		if(!isset($this->value))
		{
			...
			$this->isValid = FALSE;
			$key = $this->name;
			$this->errorMessage = new XEObject(-1, sprintf($lang->filter->isnull, $lang->{$key} ? $lang->{$key} : $key));
		}
	}
